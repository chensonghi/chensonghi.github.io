...
![image-20231218230623159](./image-20231218230623159-1707064057755-1.png)

mad，开局这里不是admin

![image-20231219003304097](./image-20231219003304097-1707064057755-2.png)

这个函数有sql注入

![image-20231218230743819](./image-20231218230743819-1707064057755-3.png)

找到逻辑

![image-20231218230846206](./image-20231218230846206-1707064057755-4.png)

继续

![image-20231218230905900](./image-20231218230905900-1707064057755-5.png)

```
$view->arrayToMarkdown(unserialize(base64_decode($goods['data'])))
```

![image-20231218231424714](./image-20231218231424714-1707064057755-6.png)
...
![image-20231218232718457](./image-20231218232718457-1707064057755-7.png)

需要数组形式的

然后构造一个sql语句

![image-20231218235801197](./image-20231218235801197-1707064057755-8.png)
...
![image-20231218235942528](./image-20231218235942528-1707064057755-9.png)

本地打一下，看见打上去了

直接RCE

![image-20231219000032765](./image-20231219000032765-1707064057755-10.png)
